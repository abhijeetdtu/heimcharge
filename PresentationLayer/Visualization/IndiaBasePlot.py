...
def show():
    try:
        ...
        return render_template('BaseMap.html' , map_content = Markup(m._repr_html_()) , bar_charts = barCharts)
...
def plotFileWithMap(filename , xAxisIndex,  yAxisForMap):
    try:
        ...
        return render_template('BaseMap.html' , map_content = Markup(m._repr_html_()) , bar_charts = barCharts , side_chart = sideChart)
